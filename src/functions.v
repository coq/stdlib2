...
#[global] Hint Resolve frefl rrefl : core.
...
Notation sval := (@sig_proj1 _ _).
Notation "@ 'sval'" := (@sig_proj1) (at level 10, format "@ 'sval'").
...
Definition s2val (u : sig2 P Q) := sig2_proj1 u.
